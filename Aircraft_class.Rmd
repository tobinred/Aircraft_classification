---
title: "Toby Maclean assignment 4"
output:
...
```{r}
set.seed(4873)
tune.out = tune(svm,as.factor(Engine)~.,data = train, kernel = "radial",ranges = list(cost = c(0.1,0.3,1,3,10,30,100,300,1000),gamma = c(0.01,0.03,0.1,0.3,1,3,10)))
tune.out 
```
...
senspec = function(table){
  ...
  avsen = paste("Mean sensitivity: ",mean(jsen,psen,pjsen))
  avspec = paste("Mean specificity: ",mean(jspec,pspec,pjspec))
